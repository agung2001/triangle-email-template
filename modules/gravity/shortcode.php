	...
	*/
	public function triangle_function($atts, $content = null){
		...
		if('user'==$request['request'] && ''!=$atts['userid']){
			...
			elseif('billing_postcode'==$atts['action'])
				return get_field('billing_postcode','user_'.$atts['userid']);
			elseif('billing_state'==$atts['action'])
				return get_field('billing_state','user_'.$atts['userid']);
			elseif('billing_city'==$atts['action'])
				return get_field('billing_city','user_'.$atts['userid']);
			elseif('billing_country'==$atts['action'])
				return get_field('billing_country','user_'.$atts['userid']);
